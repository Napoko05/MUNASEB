    ...
    <div class="vh-100 d-flex justify-content-center align-items-center bg-light">
        <div class="card shadow-lg rounded-4 w-100" style="max-width: 900px;">
            <div class="card-header bg-primary text-white text-center py-4 rounded-top-4">
                <h2 class="fw-bold mb-0">Récapitulatif de votre demande</h2>
                <p class="mb-0">Vérifiez vos informations avant de soumettre</p>
            </div>
            ...
            <div class="card-body p-5">
                <div class="row mb-4">
                    ...
                    <div class="col-md-9">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong>INE :</strong> {{ $data['step1']['ine'] }}</li>
                            ...
                            <li class="list-group-item"><strong>Type de document :</strong> {{ $data['step2']['typedoc'] }} - {{ $data['step2']['numdoc'] }}</li>
                            <li class="list-group-item"><strong>Université / Filière :</strong> {{ $data['step2']['idUniversite'] }} / {{ $data['step2']['idFiliere'] }}</li>
                ...
                <form action="{{ route('munaseb.adherant.soumettre') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('munaseb.adherant.adhesionstep3') }}" class="btn btn-outline-secondary">
