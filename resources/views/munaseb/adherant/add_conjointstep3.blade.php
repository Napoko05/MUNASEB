        ...
        <div class="w-100" style="max-width: 900px;">
            ...
            <div class="card shadow-lg rounded-4">
                ...
                <div class="card-body p-5">
                    <form action="{{ route('munaseb.adherant.postConjointStep3') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Acte de Mariage en (PDF)</label>
                            <input type="file" name="doc_act" accept=".pdf" class="form-control" required>
                        </div>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                            <label class="form-label fw-semibold">Carte munaseb conjoint(e) (PDF)</label>
                            <input type="file" name="doc_cart" accept=".pdf" class="form-control" required>
                        </div>

                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ route('munaseb.adherant.postStep2') }}" class="btn btn-outline-secondary">
