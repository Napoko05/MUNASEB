...
@section('title', 'Enfant - Récapitulatif')
    ...
    <div class="vh-100 d-flex justify-content-center align-items-center bg-light">
        <div class="card shadow-lg rounded-4 w-100" style="max-width: 900px;">
            <div class="card-header bg-primary text-white text-center py-4 rounded-top-4">
                <h2 class="fw-bold mb-0">Récapitulatif de l’enfant</h2>
            ...
            <div class="card-body p-5">
                ...
                <form action="{{ route('enfant.soumettre') }}" method="POST">
                    @csrf
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('enfant.step3') }}" class="btn btn-outline-secondary">
