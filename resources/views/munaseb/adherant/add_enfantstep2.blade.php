                    ...
                    <form action="{{ route('munaseb.adherant.postEnfantStep2') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="typedoc" class="form-select" required>
                                    ...
                                    <option value="CNI">Extrait de naissance</option>
                                    <option value="PASSPORT">Autre jugement supplétif d'acte de naissance</option>
                                </select>
                            </div>
                             {{-- Type de document & numéro parent mutualiste --}}
                            <div class="col-md-6">
                                <label class="form-label fw-semibold">Type de document parent</label>
                                <select name="typedoc" class="form-select" required>
                                    <option value="">Sélectionner...</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tel1" class="form-control" placeholder="contact enfant ou parent" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" placeholder="Email parent" required>
                        </div>
