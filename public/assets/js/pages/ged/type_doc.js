...
var KSMain = function () {
    ...
    var type_doc = function () {
        ...
        $('.btn-add-row-type-donnee').click(function () {
            ...
            $('#dt_type_doc_courrier tbody').append(
                    '<tr>' +
                    ...
                    '    </td>' +
                    '    <td>' +
                    '        <div class="checkbox"><label><input onchange="set_jquery_validator(this)" value="required" type="checkbox"> Requis </label></div>' +
        ...
        $("#btn_type_doc_cancel").click(function () {
            $('#menu_item_131').click();
        });
                    ...
                    fields: {
                        'code': {
                            validators: {
                                ...
                                remote: {
                                    data: function () {
                                        return {id: $('#____id').val(), _token: $(form).data('token')};
                                    },
                ...
                validator.validate().then(function (status) {
                    if (status == 'Valid') {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                set_fname_by_selector('#dt_type_doc_courrier .libelle_propriete', 'libelle_propriete[]');
                                KTApp.showPageLoading();
    ...
    return {
        init: function () {
            form = document.querySelector('#frm_type_doc_courrier');
            submitButton = document.querySelector('#btn_type_doc_submit');
            handleForm();
            type_doc();
            handleTypedocrow('.delete_type_doc_row');
        }
    };
}();
