...
var KSGed = function () {
   $('.btn_new').click(function () {
        ks_load_modal($(this).data('url'), $(this).data('modal-size'), {callback: $(this).data('callback'), niveauAccess: $('#kt_app_content').data('niveau-access'), curentFolder: $('#kt_app_content').data('curent-folder')}, '1');
    });
    ...
    var handleDeplacerfolder = () => {
        $('.deplacer_folder').click(function () {
            ks_load_modal($(table).data('url-deplacer-folder'), 'modal-md', {id: $(this).data('id'), callback: $('#kt_app_content').data('callback')}, '1');
        });
    };
    ...
    var handleDT = function () {
        datatable = $(table).DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.direction = $('#kt_app_content').data('niveau-direction');
                }
            },
            order: [[1, 'asc']],
            columnDefs: [
        ...
        datatable.on('draw', function () {
            ...
            handleDeplacerfolder('.deplacer_folder');
