...
var KSPara = function () {
                        ...
                        'matricule': {
                            validators: {
                                remote: {
                                    ...
                                    method: 'GET',
                                    url: $(form).data('validate-matricule-url')
                                }
                            }
                        },
                        'nom': {
    ...
    return {
        init: function () {
            ...
            submitButton = document.querySelector('#btn_new_personnel_submit');
            $('#frm_personnel_new .fselect2').select2();
