...
var KSMain = function () {
                            ...
                            validators: {
                                remote: {
                                    data: function () {
                                        return {
                                            id: $('#__id').val(),
                                            designation: $('#__designation').val()
                                        };
                                    },
                                    message: lang.msg_scode_desig_is_used,
                                    method: 'GET',
                                    url: $(form).data('validate-produit-url')
                                }
                            }
                        },
                        'designation': {
    ...
    return {
        init: function () {
            form = document.querySelector('#frm_new_produit');
            submitButton = document.querySelector('#btn_submit');
            $('#frm_new_produit .fselect2').select2({allowClear: true});
            $('#frm_new_produit .mfselect2').select2({allowClear: true, minimumInputLength: 2});
