...
var KSBdhebergement = function () {
    ...
    var handleDT = function () {
        datatable = $(table).DataTable({
            ...
            columns: [
                ...
                {data: 'dateentree', name: 'dateentree'},
                {data: 'datesortie', name: 'datesortie'},
                {data: 'tel', name: 'tel'},
    ...
    return {
        init: function () {
            table = document.querySelector('#dt_bdhebergement');
            handleDT();
