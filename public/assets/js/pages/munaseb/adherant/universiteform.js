...
var KSMain = function () {
    ...
    $('#_idRegion').change(function () {
        var data = 'data-region';
        $('#_idProvince').val('').trigger('change');
        $('#_idCommune').val('').trigger('change');
        filter_combo_by_data('#_idProvince', data , this);
    });
    
    $('#_idProvince').change(function () {
        var data = 'data-province';
        $('#_idCommune').val('').trigger('change');
        filter_combo_by_data('#_idCommune', data , this);
    });
                        ...
                        'code': {
                            validators: {
                                ...
                                remote: {
                                    ...
                                    method: 'GET',
                                    url: $(form).data('validate-universite-url')
                                }
                            }
                        },
                        'designation': {
    ...
    return {
        init: function () {
            form = document.querySelector('#frm_new_universite');
            submitButton = document.querySelector('#btn_submit');
            $('#frm_new_universite .fselect2').select2();
            handleForm();
        }
    };
}();
