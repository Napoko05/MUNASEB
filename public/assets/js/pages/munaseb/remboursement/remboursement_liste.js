...
var KSRemboursement = function () {
    ...
    var handleDT = function () {
        datatable = $(table).DataTable({
            ...
            columnDefs: [
                ...
                {
                    targets: [8], // Index of the column to center (e.g., first column)
                    className: 'text-end'
                }
            ],
            columns: [
                ...
                {data: 'numDemande', name: 'numDemande'},
                ...
                {data: 'montantTotal', name: 'montantTotal'},
    ...
    var handleCircuit = () => {
     ...
     var handleConsulter = () => {
        $('.consult_row').click(function () {
            ks_load_view($(table).data('consult-url') + '?id=' + $(this).data('id'), null, {id: $(this).data('id')});
        });
    };
    ...
    return {
        init: function () {
            table = document.querySelector('#dt_remboursement');
            handleDT();
