...
var KSPrisencharge = function () {
    ...
    var handleDT = function () {
        datatable = $(table).DataTable({
            ...
            columns: [
                ...
                {data: 'etpeactuel', name: 'etpeactuel'},
                {data: 'mntTotal', name: 'mntTotal'},
                {data: 'mntpartetu', name: 'mntpartetu'},
                {data: 'mntpartcenou', name: 'mntpartcenou'},
    ...
    return {
        init: function () {
            table = document.querySelector('#dt_prisencharge');
            handleDT();
