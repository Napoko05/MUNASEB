...
var KSReglementfraisetudiant = function () {
    ...
    var handleDT = function () {
        datatable = $(table).DataTable({
            ...
            columns: [
                ...
                {data: 'numpaiement', name: 'numpaiement'},
    ...
    return {
        init: function () {
            table = document.querySelector('#dt_reglementfraisetudiant');
            handleDT();
