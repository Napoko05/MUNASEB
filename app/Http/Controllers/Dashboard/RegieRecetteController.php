...
class RegieRecetteController extends Controller
{
    /**
    ...
    public function index()
{
    ...
    public function reabonnementEnCours()
    {
        ...
        return view('dashboard.regie_recette.index', compact('dossiers', 'titre'));
    }
    ...
    public function detailProfil($profilId)
    {
        ...
        return view('dashboard.regie_recette.detail_profil', compact('profil'));
    }
    ...
    public function detailAdhesion($dossierId)
    {
        ...
        return view('dashboard.regie_recette.detail_adhesion', compact('dossier'));
    }
    ...
    public function cartes()
    {
        ...
        return view('dashboard.regie_recette.cartes', compact('cartes', 'titre'));
    }
    ...
    public function stats()
    {
        ...
        return view('dashboard.regie_recette.stats', compact(
            'total',
            'valide',
            'rejete',
            'enAttente',
